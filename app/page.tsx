...
export default async function Home(){
  ...
  return <>
    <header className="header"><div className="container" style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}><div className="logo">Crypto <span>Tahlil</span> UZ</div><Link href="/obuna" className="headerCta">Obuna bo‘lish</Link></div></header>
