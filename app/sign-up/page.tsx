  ...
  return (
    <>
      ...
      <main className="container" style={{ maxWidth: 420, margin: '0 auto', paddingTop: 48, paddingBottom: 64 }}>
        ...
        <p style={{ color: '#848e9c', marginBottom: 24, fontSize: 14 }}>Email va parol bilan yangi hisob yarating.</p>
        ...
        <p style={{ marginTop: 20, fontSize: 14, color: '#848e9c', textAlign: 'center' }}>
          ...
          <Link href="/sign-in" style={{ color: '#f0b90b', fontWeight: 600 }}>Kirish</Link>
        </p>
      </main>
