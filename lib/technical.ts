...
export function analyze(candles: Candle[], interval: string = '1h'): TechnicalResult {
  ...
  const bearish = `Narx EMA20/EMA50 ostida qolish va momentum susayishi ${fmt(deepSupport)} support zonasini qayta test qilish xavfini oshiradi.`
